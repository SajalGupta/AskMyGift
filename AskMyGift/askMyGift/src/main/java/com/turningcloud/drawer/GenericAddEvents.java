	   ...
	   public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {  
	       ...
	       shared = getActivity().getSharedPreferences("MyPrefs", Context.MODE_PRIVATE);
	        ...
	        EndateOfEvent.requestFocus();
		      ...
		      titleEvent=(EditText) rootView.findViewById(R.id.titleGenericEvent);
		      descriptionEvents=(EditText) rootView.findViewById(R.id.descriptionGenericEvent);
	        ...
	        addGenericEvent=(Button) rootView.findViewById(R.id.addGenericEvent);
	        addGenericEvent.setOnClickListener(new View.OnClickListener() {
