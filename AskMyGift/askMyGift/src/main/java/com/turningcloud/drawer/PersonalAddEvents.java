...
public class PersonalAddEvents extends Fragment {  
	...
	EditText StartdateOfEvent,titleEvent,descriptionEvents,EndateOfEvent;
	   ...
	   public PersonalAddEvents() {  
		   
	   }  

	   @Override  
	   public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {  
	       View rootView = inflater.inflate(R.layout.personal_add_events, container, false);  
	       ...
	       shared = getActivity().getSharedPreferences("MyPrefs", Context.MODE_PRIVATE);
	        ...
	        EndateOfEvent.requestFocus();
		      ...
		      titleEvent=(EditText) rootView.findViewById(R.id.titlePersonalEvent);
		      descriptionEvents=(EditText) rootView.findViewById(R.id.descriptionpersonalEvent);
	      ...
	      addEvent=(Button) rootView.findViewById(R.id.addPersonalEvent);
	   ...
	   private class PersonalAsyntask extends AsyncTask<String, Void, String>{
			...
			private String POST(String string, JSONArray arr)  {
		        ...
		        try {
		            ...
		            if(inputStream != null){
		                ...
		                Log.d("Personal response", result);
	    	...
	    	protected void onPostExecute(String result) {
				...
				Toast.makeText(getActivity(), "Event has been successfully updated", Toast.LENGTH_SHORT).show();	
