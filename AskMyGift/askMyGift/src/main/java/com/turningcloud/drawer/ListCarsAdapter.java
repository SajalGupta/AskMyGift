...
public class ListCarsAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = this.inflater.inflate(R.layout.gift_list_layout_items, parent, false);

			holder.txtModel = (TextView) convertView.findViewById(R.id.txt_car_model);
			holder.txtColor = (TextView) convertView.findViewById(R.id.txt_car_color);
